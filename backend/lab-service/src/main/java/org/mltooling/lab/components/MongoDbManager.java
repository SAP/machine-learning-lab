...
public class MongoDbManager {
    ...
    // ================ Constructors & Main ================================= //
    public MongoDbManager(String mongoHost, int mongoPort, boolean sslEnabled, String mongoUser, String mongoPassword) {
        MongoCredential mongoCredential = MongoCredential.createCredential(mongoUser, DEFAULT_AUTHENTICATION_DATABASE, mongoPassword.toCharArray());
    ...
    /**
     * Get the MongoClient initialized for the whole application. On first call, the MongoClient instance is initialized using
     * the Lab's configuration to get the Mongo connection information.
     *
