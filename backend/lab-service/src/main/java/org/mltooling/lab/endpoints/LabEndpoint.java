...
public class LabEndpoint extends AbstractApiEndpoint<LabEndpoint> {
  // ================ Constants =========================================== //
  private static final String WARNING_PROFILE_NOT_INJECTED = "User profile not injected.";
  private static final String WARNING_COULD_NOT_RESOLVE_PROFILE = "Could not resolve profile from credentials.";
  ...
  public Response createProject(
      @ApiParam(value = "Project Configuration", required = true) LabProjectConfig config,
      @Pac4JProfile MongoProfile commonProfile,
      @BeanParam DefaultHeaderFields defaultHeaders) {
    if (commonProfile == null) {
      log.warn(WARNING_PROFILE_NOT_INJECTED);
      return UnifiedResponseFactory.getErrorResponse(
          Response.Status.UNAUTHORIZED, WARNING_COULD_NOT_RESOLVE_PROFILE);
    }
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @ApiOperation(
      value = "Checks if a project name is available for project creation .",
  ...
  @Pac4JSecurity(
      ...
      authorizers = AuthorizationManager.AUTHORIZER_IS_AUTHENTICATED)
  public Response isProjectAvailable(
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @ApiOperation(
      value = "Delete a project and all its associated networks, services & data.",
      response = StatusMessageFormat.class)
  @Pac4JSecurity(
      clients = {
        AuthorizationManager.PAC4J_CLIENT_COOKIE,
  ...
  @ApiOperation(
      value = "Get all available projects with details.",
      response = ListOfLabProjectsResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
        AuthorizationManager.PAC4J_CLIENT_COOKIE,
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @ApiOperation(
      value = "Get project token for the specified project.",
  ...
  @Pac4JSecurity(
      ...
      authorizers = AuthorizationManager.AUTHORIZER_PROJECT)
  public Response createProjectToken(
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @BeanParam DefaultHeaderFields defaultHeaders) {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @ApiOperation(
      value = "Get details for the specified project.",
      response = LabProjectResponse.class)
  @Pac4JSecurity(
      clients = {
        AuthorizationManager.PAC4J_CLIENT_COOKIE,
        AuthorizationManager.PAC4J_CLIENT_HEADER
  ...
  public Response getProject(
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @ApiParam(value = "Expand Information (files, services, experiments...)", required = false)
          @QueryParam(LabApi.PARAM_EXPAND)
          Boolean expand,
      @BeanParam DefaultHeaderFields defaultHeaders) {
  ...
  @ApiOperation(
      value = "Get all services of a project with details and general statistics.",
      response = ListOfLabServicesResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
        AuthorizationManager.PAC4J_CLIENT_COOKIE,
  ...
  @ApiOperation(
      value = "Get a specific project service by name or type.",
  ...
  public Response getService(
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @ApiParam(value = "Service Name or Type", required = true) @PathParam(LabApi.PARAM_SERVICE)
          String service,
      @BeanParam DefaultHeaderFields defaultHeaders) {
  ...
  @ApiOperation(
      value = "Delete a specific project service by name or type.",
      response = StatusMessageFormat.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
  ...
  @ApiOperation(
      value = "Deploy a service for a specified project based on a provided image.",
      response = LabServiceResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
  ...
  public Response deployService(
      @ApiParam(value = "Service Configuration", required = false) Map<String, String> config,
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @ApiParam(value = "Image Name", required = true) @QueryParam(LabApi.PARAM_DOCKER_IMAGE)
          String image,
      @ApiParam(value = "Service Name", required = false) @QueryParam(LabApi.PARAM_NAME)
          String name,
      @Pac4JProfile MongoProfile commonProfile,
      @BeanParam DefaultHeaderFields defaultHeaders) {
    if (commonProfile == null) {
    ...
    return UnifiedResponseFactory.getResponse(
        labHandler.deployService(project, image, name, config));
  }

  @POST
  @Path(LabApi.METHOD_DEPLOY_MODEL)
  @ApiOperation(
      value = "Deploy a model as a service for a specified project.",
      response = LabServiceResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
  ...
  public Response deployModel(
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @ApiParam(value = "Model Key", required = true) @QueryParam(LabApi.PARAM_FILE_KEY)
          String fileKey,
      @ApiParam(
              value = "JSON config containing the environment variables to overwrite the default",
              required = false)
    ...
    labHandler.setAuthProfile(commonProfile);
    return UnifiedResponseFactory.getResponse(
        labHandler.deployModel(project, fileKey, name, config));
  }
  ...
  @ApiOperation(
      value = "Get all jobs of a project with details and general statistics.",
      response = ListOfLabJobsResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
        AuthorizationManager.PAC4J_CLIENT_COOKIE,
  ...
  @ApiOperation(
      value = "Get all scheduled jobs of a project.",
      response = ListOfLabScheduledJobsResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
        AuthorizationManager.PAC4J_CLIENT_COOKIE,
  ...
  @ApiOperation(
      value = "Get a specific project job by name or type.",
      response = LabJobResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
        AuthorizationManager.PAC4J_CLIENT_COOKIE,
  ...
  @ApiOperation(
      value = "Deploy a job for a specified project based on a provided image.",
      response = LabJobResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Consumes(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      ...
      authorizers = AuthorizationManager.AUTHORIZER_PROJECT)
  public Response deployJob(
      @ApiParam(value = "Job Configuration", required = false) Map<String, String> config,
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @ApiParam(value = "Image Name", required = true) @QueryParam(LabApi.PARAM_DOCKER_IMAGE)
          String image,
      @ApiParam(
              value =
                  "Cron Schedule in UNIX format. If specified, the job is executed repeatedly"
                      + " according to the cron definition. A job cannot run more often than once"
                      + " a minute.",
              required = false)
          @QueryParam(LabApi.PARAM_SCHEDULE)
          String schedule,
      @ApiParam(value = "Job Name", required = false) @QueryParam(LabApi.PARAM_NAME) String name,
      @BeanParam DefaultHeaderFields defaultHeaders) {
    return UnifiedResponseFactory.getResponse(
        labHandler.deployJob(project, image, name, schedule, config));
  }
  ...
  @ApiOperation(
      value = "Get all experiments of a project with details.",
      response = ListOfLabExperimentsResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
        AuthorizationManager.PAC4J_CLIENT_COOKIE,
  ...
  @ApiOperation(
      value = "Deletes an experiment from a specified project.",
      response = StatusMessageFormat.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
  ...
  public Response deleteExperiment(
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @ApiParam(value = "Experiment ID", required = true) @QueryParam(LabApi.PARAM_EXPERIMENT)
          String experimentId,
      @Pac4JProfile MongoProfile commonProfile,
      @BeanParam DefaultHeaderFields defaultHeaders) {
    labHandler.setAuthProfile(commonProfile);
  ...
  @ApiOperation(
      value = "Sync an experiment to the experiments DB of a project.",
      response = StringResponse.class)
  @ApiResponses(
      value = {
  ...
  @Pac4JSecurity(
      ...
      authorizers = AuthorizationManager.AUTHORIZER_PROJECT)
  public Response syncExperiment(
      @ApiParam(value = "Experiment", required = true) LabExperiment experiment,
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @BeanParam DefaultHeaderFields defaultHeaders) {
  ...
  @ApiOperation(
      value =
          "Get all files of a project with details and general statistics filtered by data type"
              + " and/or prefix.",
      response = ListOfLabFilesResponse.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
        AuthorizationManager.PAC4J_CLIENT_COOKIE,
  ...
  public Response getFiles(
      ...
      @ApiParam(
              value = "Data Type",
              required = false,
              allowableValues = LabFileDataType.ALLOWABLE_VALUES)
          @QueryParam(LabApi.PARAM_DATA_TYPE)
          String dataType,
      @ApiParam(
              value =
                  "File Key Prefix. If data type is provided, will prefix will be applied for"
                      + " datatype, otherwise on full remote storage.",
              required = false)
          @QueryParam(LabApi.PARAM_PREFIX)
          String prefix,
      @ApiParam(value = "Aggregate Versions", required = false)
          @QueryParam(LabApi.PARAM_AGGREGATE_VERSIONS)
          Boolean aggregateVersions,
      @BeanParam DefaultHeaderFields defaultHeaders) {
    return UnifiedResponseFactory.getResponse(
        labHandler.getFiles(project, LabFileDataType.from(dataType), prefix, aggregateVersions));
  }

  @DELETE
  @Path(LabApi.METHOD_DELETE_FILE)
  @ApiOperation(
      value = "Deletes a file from a specified project.",
      response = StatusMessageFormat.class)
  @Produces(MediaType.APPLICATION_JSON)
  @Pac4JSecurity(
      clients = {
  ...
  public Response deleteFile(
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @ApiParam(value = "File Key", required = true) @QueryParam(LabApi.PARAM_FILE_KEY)
          String fileKey,
      @ApiParam(value = "Keep the n-latest Versions", required = false)
          @QueryParam(LabApi.PARAM_KEEP_LATEST_VERSIONS)
          Integer keepLatestVersions,
      @Pac4JProfile MongoProfile commonProfile,
      @BeanParam DefaultHeaderFields defaultHeaders) {
    labHandler.setAuthProfile(commonProfile);
    return UnifiedResponseFactory.getResponse(
        labHandler.deleteFile(project, fileKey, keepLatestVersions));
  }
  ...
  @POST
  @ApiOperation(
      value = "Upload file to remote storage of selected project and returns key.",
      response = StringResponse.class)
  ...
  public Response uploadFile(
      @ApiParam(value = "File Input Stream", required = false, hidden = true)
          @FormDataParam(LabApi.PARAM_FILE)
          InputStream fileStream,
      @ApiParam(value = "File Metadata", required = false, hidden = true)
          @FormDataParam(LabApi.PARAM_FILE)
          FormDataContentDisposition fileDetail,
      @ApiParam(value = "File Name", required = false, hidden = true) @FormDataParam("name")
          String uppyFileName,
      @ApiParam(value = "Project Name", required = true) @PathParam(LabApi.PARAM_PROJECT)
          String project,
      @ApiParam(
              value = "Data Type of File.",
              required = true,
              allowableValues = LabFileDataType.ALLOWABLE_VALUES)
          @QueryParam(LabApi.PARAM_DATA_TYPE)
          @Nullable
          String dataType,
      @ApiParam(
              value = "File Name. If not provided, the filename from file metadata will be used.",
              required = false)
          @QueryParam(LabApi.PARAM_FILE_NAME)
          String fileName,
      @ApiParam(value = "Versioning activated", required = false, defaultValue = "true")
          @QueryParam(LabApi.PARAM_VERSIONING)
          @Nullable
          Boolean versioning,
      @Pac4JProfile MongoProfile commonProfile,
      @BeanParam DefaultHeaderFields defaultHeaders) {
    ...
    if (StringUtils.isNullOrEmpty(fileName)) {
      if (fileDetail == null || StringUtils.isNullOrEmpty(fileDetail.getFileName())) {
        return UnifiedResponseFactory.getErrorResponse(
            "fileName parameter is empty and no name provided in file metadata.");
      }
    ...
    labHandler.setAuthProfile(commonProfile);
    return UnifiedResponseFactory.getResponse(
        labHandler.uploadFile(
            project, fileStream, fileName, LabFileDataType.from(dataType), versioning, metadata));
  }
        ...
        ContentDisposition.type("attachment")
            .fileName(
                FileHandlerUtils.getFileNameFromKey(
                    labFile.getKey(), true)) // always remove version here
            .size(labFile.getSize())
            .creationDate(labFile.getModifiedAt())
            .modificationDate(labFile.getModifiedAt())
            .build();

    return UnifiedResponseFactory.getFileDownloadResponse(
        labFile.getFileStream(), contentDisposition);
  }
