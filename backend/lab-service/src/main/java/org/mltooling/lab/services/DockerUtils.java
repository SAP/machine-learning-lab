...
public class DockerUtils {
    ...
    // ================ Constants =========================================== //
    private final static Logger log = LoggerFactory.getLogger(DockerUtils.class);
    ...
    public static Map<String, String> convertEnvListToMap(List<String> envVariables) {
        ...
        for (String envVar : envVariables) {
            String[] envVarSplit = envVar.split("=", 2); // just split by first equal sign (limit: 2-1=1); all following equal signs belong to the env's value
    ...
    public static class Network {
        ...
        /**
         * Compare two network addresses octet-wise and return the highest network address.
         * Examples:
         * - 172.33.0.0 is greater than 171.33.0.0
         * - 172.34.0.0 is greater than 172.33.255.255
        ...
        /**
         * Increases the ip address by 1, starting at the third octet.
         * Examples:
         * - network ipaddress = 172.33.0.12 => 172.33.1.0
         * - network ipaddress = 172.33.255.39 => 172.34.0.0
         * - network ipaddress = 255.255.255.0 => 255.255.255.0
         *
        ...
        public static Network nextSubnet(Network network) {
            ...
            return new Network(String.format("%s.%s.%s.%s/%s",
                                             newOctets[0],
                                             newOctets[1],
                                             newOctets[2],
                                             newOctets[3], network.getPrefixLength())
            );
        }
