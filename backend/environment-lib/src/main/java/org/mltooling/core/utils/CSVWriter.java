...
public class CSVWriter {
    ...
    private final static String DEFAULT_OUTPUT_DELIMITER = ";";
    ...
    public static List<Map<String, String>> loadCSV(File csvFile, String outputDelimiter) {
        ...
        try {
            ...
            try {
                reader = new BufferedReader(new InputStreamReader(new FileInputStream(csvFile), StringUtils.UTF_8_CHARSET));
    ...
    private String cleanField(String field) {
        ...
        field = field.replace(outputDelimiter, " ")
                     .replace("\"", " ")
