...
public class UnifiedFormat {
    ...
    public UnifiedFormat setErrorStatus(Integer code, Exception ex, boolean withStackTrace) {
        if (withStackTrace) {
            setErrorStatus(ex.getMessage(), code, ex.getClass().getSimpleName(), LogUtils.getStackTrace(ex));
        } else {
    ...
    public UnifiedFormat setErrorStatus(String message, Integer code, @Nullable String type, @Nullable String description) {
    ...
    public UnifiedFormat setNotImplementedStatus() {
        setErrorStatus(EnglishReasonPhraseCatalog.INSTANCE.getReason(HttpStatus.SC_NOT_IMPLEMENTED, Locale.ENGLISH), HttpStatus.SC_NOT_IMPLEMENTED);
        return this;
    }
    ...
    public UnifiedFormat setNotFoundStatus() {
        setErrorStatus(EnglishReasonPhraseCatalog.INSTANCE.getReason(HttpStatus.SC_NOT_FOUND, Locale.ENGLISH), HttpStatus.SC_NOT_FOUND);
        return this;
    }
