...
public class LabAuthApiClient extends AbstractApiClient<LabAuthApiClient> implements LabAuthApi {
    ...
    public SingleValueFormat<LabUser> createUser(String user, String password) {
        return executeRequest(Unirest.post(getEndpointUrl() + METHOD_CREATE_USER)
    ...
    public SingleValueFormat<String> loginUser(String user, String password) {
        final String auth = Base64.getEncoder().encodeToString((String.format("%s:%s", user, password)).getBytes());
        this.setHeader(ApiUtils.AUTHORIZATION_HEADER, String.format("Basic %s", auth));

        return executeRequest(Unirest.get(getEndpointUrl() + METHOD_GET_LOGIN_TOKEN)
                                     .getHttpRequest(),
    ...
    public SingleValueFormat<String> logoutUser() {
        return executeRequest(Unirest.get(getEndpointUrl() + METHOD_LOGOUT).getHttpRequest(), new TypeToken<SingleValueFormat<String>>() {}.getType());
    }

    @Override
    public SingleValueFormat<String> refreshToken() {
        return executeRequest(Unirest.get(getEndpointUrl() + METHOD_REFRESH_TOKEN)
                                     .getHttpRequest(),
                              new TypeToken<SingleValueFormat<String>>() {}.getType());
    }
    ...
    public SingleValueFormat<String> createApiToken(String user) {
        return executeRequest(Unirest.get(getEndpointUrl() + METHOD_GET_API_TOKEN)
    ...
    public SingleValueFormat<LabUser> getMe() {
        return executeRequest(Unirest.get(getEndpointUrl() + METHOD_GET_ME).getHttpRequest(),
                              new TypeToken<SingleValueFormat<LabUser>>() {}.getType());
    }

    @Override
    public SingleValueFormat<LabUser> getUser(String user) {
        return executeRequest(Unirest.get(getEndpointUrl() + METHOD_GET_USER)
                                     .routeParam(PARAM_USER, user).getHttpRequest(),
                              new TypeToken<SingleValueFormat<LabUser>>() {}.getType());
    }

    @Override
    public ValueListFormat<LabUser> getUsers() {
        return executeRequest(Unirest.get(getEndpointUrl() + METHOD_GET_USERS)
                                     .getHttpRequest(),
    ...
    public StatusMessageFormat deactivateUsers(List<String> users) {
        HttpRequest request = Unirest.post(getEndpointUrl() + METHOD_DEACTIVATE_USERS)
                                     .header(ApiUtils.CONTENT_TYPE_HEADER, ApiUtils.CONTENT_TYPE_JSON)
                                     .body(new Gson().toJson(users)).getHttpRequest();
    ...
    public StatusMessageFormat deleteUser(String user) {
        return executeRequest(Unirest.delete(getEndpointUrl() + METHOD_DELETE_USER)
                                     .routeParam(PARAM_USER, user).getHttpRequest(),
    ...
    public SingleValueFormat<String> updatePermissions(String user, List<String> permissions, @Nullable Boolean deactivateToken) {
        ...
        HttpRequest request = Unirest.post(getEndpointUrl() + METHOD_UPDATE_USER_PERMISSIONS)
                                     .header(ApiUtils.CONTENT_TYPE_HEADER, ApiUtils.CONTENT_TYPE_JSON)
                                     .routeParam(PARAM_USER, user)
                                     .body(new Gson().toJson(permissions)).getHttpRequest();
    ...
    public SingleValueFormat<String> updateUserPassword(String user, String password) {
        return executeRequest(Unirest.get(getEndpointUrl() + METHOD_UPDATE_USER_PASSWORD)
                                     .routeParam(PARAM_USER, user)
                                     .queryString(PARAM_PASSWORD, password).getHttpRequest(),
                              new TypeToken<SingleValueFormat<String>>() {}.getType());
    }

    @Override
    public SingleValueFormat<String> addUserToProject(String user, String project) {
        return executeRequest(Unirest.get(getEndpointUrl() + METHOD_ADD_USER_TO_PROJECT)
                                     .routeParam(PARAM_USER, user)
                                     .routeParam(LabApi.PARAM_PROJECT, project).getHttpRequest(),
                              new TypeToken<SingleValueFormat<String>>() {}.getType());
    }

    @Override
    public SingleValueFormat<String> removeUserFromProject(String user, String project) {
        return executeRequest(Unirest.delete(getEndpointUrl() + METHOD_REMOVE_USER_FROM_PROJECT)
                                     .routeParam(PARAM_USER, user)
                                     .routeParam(LabApi.PARAM_PROJECT, project).getHttpRequest(),
                              new TypeToken<SingleValueFormat<String>>() {}.getType());
    }
