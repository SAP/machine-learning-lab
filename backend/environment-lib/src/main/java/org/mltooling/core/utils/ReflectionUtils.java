...
public class ReflectionUtils {
  ...
  public static <T> T invokeSuperMethod(Object instance, String methodName, Object... params)
      throws Exception {
  ...
  public static <T> T invokeMethod(
      Class clazz, Object instance, String methodName, Object... params) throws Exception {
    ...
    if (allMethods != null && allMethods.length > 0) {
      ...
      Class[] paramClasses =
          Arrays.stream(params).map(p -> p != null ? p.getClass() : null).toArray(Class[]::new);
      ...
      throw new Exception(
          "There are no methods found with name "
              + methodName
              + " and params "
