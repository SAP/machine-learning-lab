...
public interface LabAuthApi {
  ...
  String METHOD_ADD_USER_TO_PROJECT =
      "/users/{" + PARAM_USER + "}/projects/{" + LabApi.PARAM_PROJECT + "}";
  String METHOD_REMOVE_USER_FROM_PROJECT =
      "/users/{" + PARAM_USER + "}/projects/{" + LabApi.PARAM_PROJECT + "}";
  ...
  SingleValueFormat<String> loginUser(
  ...
  SingleValueFormat<String> updatePermissions(
      String user,
      List<String> permissions,
      @Nullable Boolean deactivateToken); // -> return updated short-term application token

  SingleValueFormat<String> updateUserPassword(
      String user, String password); // -> return updated short-term application token

  SingleValueFormat<String> addUserToProject(
      String user, String project); // -> return updated short-term application token

  SingleValueFormat<String> removeUserFromProject(
      String user, String project); // -> return updated short-term application token
}
