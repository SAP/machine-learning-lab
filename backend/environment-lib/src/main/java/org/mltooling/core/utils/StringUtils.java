...
public final class StringUtils {
  ...
  public static final Pattern SIMPLIFY_STRING_PATTERN = Pattern.compile("[^a-zA-Z0-9-]");
  ...
  public static String extractCharsBetweenTwoWords(
      String sentence, String firstWord, String lastWord) {
  ...
  public static List<String> extractAllStringsBetweenTwoWords(
      String sentence, String firstWord, String lastWord) {
  ...
  public static String removeStringAfterNOccurrences(
      String str, String strToReplace, int nOccurrences) {
