...
public interface LabApi extends BaseApi {
    ...
    String METHOD_GET_PROJECT_SERVICE = "/projects/{" + PARAM_PROJECT + "}/services/{" + PARAM_SERVICE + "}";
    String METHOD_DELETE_PROJECT_SERVICE = "/projects/{" + PARAM_PROJECT + "}/services/{" + PARAM_SERVICE + "}";
    String METHOD_GET_PROJECT_SERVICE_LOGS = "/projects/{" + PARAM_PROJECT + "}/services/{" + PARAM_SERVICE + "}/logs";
    ...
    String METHOD_DELETE_SCHEDULED_JOBS = "/projects/{" + PARAM_PROJECT + "}/jobs/scheduled/{" + PARAM_JOB + "}";
    ...
    String FILE_METADATA_PREFIX = "x-amz-meta-"; // metadata provided in the headers needs to have the x-amz-meta prefix (S3 conform)
    ...
    SingleValueFormat<LabService> deployService(String project, String image, @Nullable String name, @Nullable Map<String, String> config);

    SingleValueFormat<LabService> deployModel(String project, String fileKey, @Nullable String name, @Nullable Map<String, String> config);
    ...
    SingleValueFormat<LabJob> deployJob(String project, String image, @Nullable String name, @Nullable String schedule, @Nullable Map<String, String> config);
    ...
    ValueListFormat<LabFile> getFiles(String project, @Nullable LabFileDataType dataType, @Nullable String prefix, @Nullable Boolean aggregateVersions);

    StatusMessageFormat deleteFile(String project, String fileKey, @Nullable Integer keepLatestVersions);

    SingleValueFormat<LabFile> getFileInfo(String project, String fileKey);

    SingleValueFormat<String> uploadFile(String project, InputStream fileStream, String fileName, LabFileDataType dataType, @Nullable Boolean versioning, @Nullable Map<String, String> metadata);
