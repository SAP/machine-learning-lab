...
public enum JsonFormatParser {
    ...
    // ================ Members ============================================= //
    private JsonSerializer<PropertyContainer> propertyContainerSerializer = new JsonSerializer<PropertyContainer>() {

        @Override
        public JsonElement serialize(PropertyContainer src, Type typeOfSrc, JsonSerializationContext
                context) {
    ...
    private JsonDeserializer<PropertyContainer> propertyContainerDeserializer = new JsonDeserializer<PropertyContainer>() {

        @Override
        public PropertyContainer deserialize(JsonElement json, Type typeOfT,
            ...
            try {
                ...
                item.setProperties(context.deserialize(json, new TypeToken<Map<String, Object>>() {}.getType()));
                return item;
            } catch (Exception e) {
                log.error("Failed to parse object (" + typeOfT.getTypeName() + ") to PropertyContainer.", e);
                return null;
            }
    ...
    private JsonSerializer<Class> classSerializer = new JsonSerializer<Class>() {
