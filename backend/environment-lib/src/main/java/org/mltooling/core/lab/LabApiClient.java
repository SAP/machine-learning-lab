...
public class LabApiClient extends AbstractApiClient<LabApiClient> implements LabApi {
  ...
  public SingleValueFormat<LabProject> createProject(LabProjectConfig config) {
    return executeRequest(
        Unirest.post(getEndpointUrl() + METHOD_CREATE_PROJECT)
            .header(ApiUtils.CONTENT_TYPE_HEADER, ApiUtils.CONTENT_TYPE_JSON)
            .body(new Gson().toJson(config))
            .getHttpRequest(),
  ...
  public StatusMessageFormat isProjectAvailable(String project) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_PROJECT_AVAILABLE)
            .getHttpRequest()
  ...
  public StatusMessageFormat deleteProject(String project) {
    return executeRequest(
        Unirest.delete(getEndpointUrl() + METHOD_DELETE_PROJECT)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project),
        new TypeToken<StatusMessageFormat>() {}.getType());
  }
  ...
  public ValueListFormat<LabProject> getProjects() {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_ALL_PROJECTS).getHttpRequest(),
  ...
  public SingleValueFormat<String> createProjectToken(String project) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_PROJECT_TOKEN)
            .routeParam(PARAM_PROJECT, project)
            .getHttpRequest(),
  ...
  public SingleValueFormat<LabProject> getProject(String project, @Nullable Boolean expand) {
    ...
    HttpRequest request =
        Unirest.get(getEndpointUrl() + METHOD_GET_PROJECT)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project);
  ...
  public ValueListFormat<LabService> getServices(String project) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_PROJECT_SERVICES)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project),
  ...
  public SingleValueFormat<LabService> getService(String project, String service) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_PROJECT_SERVICE)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
  ...
  public StatusMessageFormat deleteService(String project, String service) {
    return executeRequest(
        Unirest.delete(getEndpointUrl() + METHOD_DELETE_PROJECT_SERVICE)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
            .routeParam(PARAM_SERVICE, service),
        new TypeToken<StatusMessageFormat>() {}.getType());
  ...
  public SingleValueFormat<String> getServiceLogs(String project, String service) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_PROJECT_SERVICE_LOGS)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
            .routeParam(PARAM_SERVICE, service),
        new TypeToken<SingleValueFormat<String>>() {}.getType());
  ...
  public SingleValueFormat<LabService> deployService(
    ...
    HttpRequest request =
        Unirest.post(getEndpointUrl() + METHOD_DEPLOY_SERVICE)
            .body(config != null ? new Gson().toJson(config) : "")
            .getHttpRequest()
            .header(ApiUtils.CONTENT_TYPE_HEADER, ApiUtils.CONTENT_TYPE_JSON)
            .routeParam(PARAM_PROJECT, project)
  ...
  public SingleValueFormat<LabService> deployModel(
    ...
    HttpRequest request =
        Unirest.post(getEndpointUrl() + METHOD_DEPLOY_MODEL)
            .body(config != null ? new Gson().toJson(config) : "")
            .getHttpRequest()
            .header(ApiUtils.CONTENT_TYPE_HEADER, ApiUtils.CONTENT_TYPE_JSON)
            .routeParam(PARAM_PROJECT, project)
  ...
  public ValueListFormat<LabJob> getJobs(String project) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_ALL_JOBS)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project),
  ...
  public ValueListFormat<LabScheduledJob> getScheduledJobs(String project) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_SCHEDULED_JOBS)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project),
  ...
  public StatusMessageFormat deleteScheduledJob(String project, String jobId) {
    return executeRequest(
        Unirest.delete(getEndpointUrl() + METHOD_DELETE_SCHEDULED_JOBS)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
  ...
  public SingleValueFormat<LabJob> getJob(String project, String job) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_JOB)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
  ...
  public StatusMessageFormat deleteJob(String project, String job) {
    return executeRequest(
        Unirest.delete(getEndpointUrl() + METHOD_DELETE_JOB)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
            .routeParam(PARAM_JOB, job),
        new TypeToken<StatusMessageFormat>() {}.getType());
  ...
  public SingleValueFormat<String> getJobLogs(String project, String job) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_JOB_LOGS)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
            .routeParam(PARAM_JOB, job),
        new TypeToken<SingleValueFormat<String>>() {}.getType());
  ...
  public SingleValueFormat<LabJob> deployJob(
    ...
    HttpRequest request =
        Unirest.post(getEndpointUrl() + METHOD_DEPLOY_JOB)
            .body(config != null ? new Gson().toJson(config) : "")
            .getHttpRequest()
            .header(ApiUtils.CONTENT_TYPE_HEADER, ApiUtils.CONTENT_TYPE_JSON)
            .routeParam(PARAM_PROJECT, project)
  ...
  public ValueListFormat<LabExperiment> getExperiments(String project) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_EXPERIMENTS)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project),
  ...
  public StatusMessageFormat deleteExperiment(String project, String experimentId) {
    return executeRequest(
        Unirest.delete(getEndpointUrl() + METHOD_DELETE_EXPERIMENT)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
  ...
  public SingleValueFormat<String> syncExperiment(String project, LabExperiment experiment) {
    return executeRequest(
        Unirest.post(getEndpointUrl() + METHOD_SYNC_EXPERIMENT)
            .body(new Gson().toJson(experiment))
            .getHttpRequest()
            .header(ApiUtils.CONTENT_TYPE_HEADER, ApiUtils.CONTENT_TYPE_JSON)
            .routeParam(PARAM_PROJECT, project),
        new TypeToken<SingleValueFormat<String>>() {}.getType());
  ...
  public ValueListFormat<LabFile> getFiles(
    ...
    HttpRequest request =
        Unirest.get(getEndpointUrl() + METHOD_GET_FILES)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project);
  ...
  public StatusMessageFormat deleteFile(
      String project, String fileKey, @Nullable Integer keepLatestVersion) {
    HttpRequest request =
        Unirest.delete(getEndpointUrl() + METHOD_DELETE_FILE)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
            .queryString(PARAM_FILE_KEY, fileKey);
  ...
  public SingleValueFormat<LabFile> getFileInfo(String project, String fileKey) {
    return executeRequest(
        Unirest.get(getEndpointUrl() + METHOD_GET_FILE_INFO)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
            .queryString(PARAM_FILE_KEY, fileKey),
        new TypeToken<SingleValueFormat<LabFile>>() {}.getType());
  }
  ...
  public SingleValueFormat<String> uploadFile(
    ...
    HttpRequest request =
        Unirest.post(getEndpointUrl() + METHOD_UPLOAD_FILE)
            .field(PARAM_FILE, progressInputStream, ContentType.APPLICATION_OCTET_STREAM, fileName)
            .getHttpRequest()
            .routeParam(PARAM_PROJECT, project)
    ...
    SingleValueFormat<String> response =
        executeRequest(request, new TypeToken<SingleValueFormat<String>>() {}.getType());
    try {
  ...
  public SingleValueFormat<LabFile> downloadFile(String project, String fileKey) {
    if (!StringUtils.isNullOrEmpty(authToken)) {
      // set auth token if not already provided -> needs to be done here because this is not using
      // the execute method
    ...
    try {
      InputStream fileStream =
          requestFile(
              Unirest.get(getEndpointUrl() + METHOD_DOWNLOAD_FILE)
                  .getHttpRequest()
                  .routeParam(PARAM_PROJECT, project)
                  .queryString(PARAM_FILE_KEY, fileKey)
                  .headers(getHeaders()));
  ...
  public static InputStream requestFile(HttpRequest request) throws Exception {
    HttpRequestBase requestObj =
        ReflectionUtils.invokeMethod(
            HttpClientHelper.class, (Object) null, "prepareRequest", (HttpRequest) request, false);
    ...
    try {
      ...
      if (response.getStatusLine().getStatusCode() < HttpStatus.SC_OK
        ...
        log.info(
            "Download was unsuccessful with status: "
        ...
        log.info(
            "Requested file on server and client match by version and size, no need to download.");
        return null;
      } else {
        ...
        return new CloseCallbackInputStream(
            responseInputStream,
            new CloseCallbackInputStream.CloseCallback() {
