#!/usr/bin/env python
# Extracted sacred library: https://github.com/IDSIA/sacred/blob/master/sacred/dependencies.py
...
def get_commit_if_possible(filename):
    ...
    try:
        ...
        # No git python installed probably
        pass
...
def gather_sources_and_dependencies(globs, base_dir=None,
                                    source_discovery_strategy: str = "imported",
                                    dependency_discovery_strategy: str = "imported"):
    ...
    gather_sources = source_discovery_strategies[source_discovery_strategy]
    sources = gather_sources(globs, base_dir)
    if main is not None:
        sources.add(main)

    gather_dependencies = dependency_discovery_strategies[dependency_discovery_strategy]
