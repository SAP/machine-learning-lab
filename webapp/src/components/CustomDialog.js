...
class CustomDialog extends Component {
	...
	render() {
		const { title, contentText, cancelBtnDisabled, primaryActionBtnDisabled, primaryActionBtnLabel, cancelBtnLabel, CustomComponent } = this.props;
		
		return (
			<Dialog className="customdialog" open={this.props.open} onClose={this.props.handleRequestClose} onKeyPress={this.onKeyPress}>
				...
				{this.props.overwriteButton === true ? (
					...
					<DialogActions>
						...
						{this.props.hideCancelBtn ? (
							...
							<Button onClick={this.props.handleRequestClose} color="primary" disabled={cancelBtnDisabled}>
								{cancelBtnLabel || "Cancel"}
							</Button>
						)}
						<Button onClick={this.props.handlePrimaryAction} disabled={primaryActionBtnDisabled} color="primary">
