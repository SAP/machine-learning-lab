...
export default class AuthApi {
   ...
   * @param {String} permission
   * @param {String} resourceNamePrefix
   * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<String>} and HTTP response
   */
  getResourcesWithPermissionWithHttpInfo(permission, resourceNamePrefix) {
    let postBody = null;
    // verify the required parameter 'permission' is set
    if (permission === undefined || permission === null) {
      throw new Error(
    ...
    // verify the required parameter 'resourceNamePrefix' is set
    if (resourceNamePrefix === undefined || resourceNamePrefix === null) {
      throw new Error(
        "Missing the required parameter 'resourceNamePrefix' when calling getResourcesWithPermission"
      );
    }
   ...
   */
  getResourcesWithPermission(permission, resourceNamePrefix) {
    return this.getResourcesWithPermissionWithHttpInfo(
      permission,
      resourceNamePrefix
    ).then(function (response_and_data) {
      return response_and_data.data;
   ...
   */
  listApiTokens() {
    return this.listApiTokensWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
