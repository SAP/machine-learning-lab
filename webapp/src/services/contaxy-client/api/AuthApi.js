...
export default class AuthApi {
   ...
   * @param {Array.<String>} opts.scopes Scopes requested for this token. If none specified, the token will be generated with same set of scopes as the authorized token.
