  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('inactiveProjectsCount')) {
        obj['inactiveProjectsCount'] = ApiClient.convertToType(
          data['inactiveProjectsCount'],
          'Number'
        );
      }
      if (data.hasOwnProperty('sharedProjectsCount')) {
        obj['sharedProjectsCount'] = ApiClient.convertToType(
          data['sharedProjectsCount'],
          'Number'
        );
      }
      ...
      if (data.hasOwnProperty('inactiveUserCount')) {
        obj['inactiveUserCount'] = ApiClient.convertToType(
      ...
      if (data.hasOwnProperty('servicesCount')) {
        obj['servicesCount'] = ApiClient.convertToType(
          data['servicesCount'],
          'Number'
        );
      }
      if (data.hasOwnProperty('filesCount')) {
        obj['filesCount'] = ApiClient.convertToType(
          data['filesCount'],
          'Number'
        );
      }
      if (data.hasOwnProperty('filesTotalSize')) {
        obj['filesTotalSize'] = ApiClient.convertToType(
          data['filesTotalSize'],
          'Number'
        );
      }
      if (data.hasOwnProperty('datasetsCount')) {
        obj['datasetsCount'] = ApiClient.convertToType(
          data['datasetsCount'],
          'Number'
        );
      }
      if (data.hasOwnProperty('datasetsTotalSize')) {
        obj['datasetsTotalSize'] = ApiClient.convertToType(
          data['datasetsTotalSize'],
          'Number'
        );
      }
      if (data.hasOwnProperty('modelsTotalSize')) {
        obj['modelsTotalSize'] = ApiClient.convertToType(
          data['modelsTotalSize'],
          'Number'
        );
      }
      if (data.hasOwnProperty('modelsCount')) {
        obj['modelsCount'] = ApiClient.convertToType(
          data['modelsCount'],
          'Number'
        );
      }
      if (data.hasOwnProperty('serverCount')) {
        obj['serverCount'] = ApiClient.convertToType(
          data['serverCount'],
          'Number'
        );
      }
      if (data.hasOwnProperty('containerCount')) {
        obj['containerCount'] = ApiClient.convertToType(
          data['containerCount'],
          'Number'
        );
      }
      if (data.hasOwnProperty('downloadedFiles')) {
        obj['downloadedFiles'] = ApiClient.convertToType(
          data['downloadedFiles'],
          'Number'
        );
      }
      if (data.hasOwnProperty('experimentsCount')) {
        obj['experimentsCount'] = ApiClient.convertToType(
          data['experimentsCount'],
          'Number'
        );
      }
      if (data.hasOwnProperty('cacheUpdateDate')) {
        obj['cacheUpdateDate'] = ApiClient.convertToType(
          data['cacheUpdateDate'],
          'Number'
        );
      }
      if (data.hasOwnProperty('cacheUpdateDuration')) {
        obj['cacheUpdateDuration'] = ApiClient.convertToType(
          data['cacheUpdateDuration'],
          'Number'
        );
      }
    }
