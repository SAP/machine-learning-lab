...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LabScheduledJob', 'model/UnifiedErrorMessage', 'model/ValueListFormatMetadata'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LabScheduledJob'), require('./UnifiedErrorMessage'), require('./ValueListFormatMetadata'));
  } else {
    // Browser globals (root is window)
    if (!root.MlLabService) {
      root.MlLabService = {};
    }
    root.MlLabService.ListOfLabScheduledJobsResponse = factory(root.MlLabService.ApiClient, root.MlLabService.LabScheduledJob, root.MlLabService.UnifiedErrorMessage, root.MlLabService.ValueListFormatMetadata);
  }
}(this, function(ApiClient, LabScheduledJob, UnifiedErrorMessage, ValueListFormatMetadata) {
  'use strict';
