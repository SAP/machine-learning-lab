  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('scriptName')) {
        obj['scriptName'] = ApiClient.convertToType(
          data['scriptName'],
          'String'
        );
      }
      if (data.hasOwnProperty('scriptType')) {
        obj['scriptType'] = ApiClient.convertToType(
          data['scriptType'],
          'String'
        );
      }
      ...
      if (data.hasOwnProperty('clientVersion')) {
        obj['clientVersion'] = ApiClient.convertToType(
          data['clientVersion'],
          'String'
        );
      }
      ...
      if (data.hasOwnProperty('dependencies')) {
        obj['dependencies'] = ApiClient.convertToType(data['dependencies'], [
          'String',
        ]);
      }
      if (data.hasOwnProperty('resources')) {
        obj['resources'] = ExperimentResources.constructFromObject(
          data['resources']
        );
      }
      ...
      if (data.hasOwnProperty('metrics')) {
        obj['metrics'] = ApiClient.convertToType(data['metrics'], {
          String: Object,
        });
      }
      if (data.hasOwnProperty('others')) {
        obj['others'] = ApiClient.convertToType(data['others'], {
          String: Object,
        });
      }
