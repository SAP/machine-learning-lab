...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LabProject', 'model/UnifiedErrorMessage', 'model/ValueListFormatMetadata'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LabProject'), require('./UnifiedErrorMessage'), require('./ValueListFormatMetadata'));
  } else {
    // Browser globals (root is window)
    if (!root.MlLabService) {
      root.MlLabService = {};
    }
    root.MlLabService.ListOfLabProjectsResponse = factory(root.MlLabService.ApiClient, root.MlLabService.LabProject, root.MlLabService.UnifiedErrorMessage, root.MlLabService.ValueListFormatMetadata);
  }
}(this, function(ApiClient, LabProject, UnifiedErrorMessage, ValueListFormatMetadata) {
  'use strict';
