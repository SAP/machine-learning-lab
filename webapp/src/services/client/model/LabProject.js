  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isAvailable')) {
        obj['isAvailable'] = ApiClient.convertToType(
          data['isAvailable'],
          'Boolean'
        );
      }
      if (data.hasOwnProperty('statistics')) {
        obj['statistics'] = LabProjectsStatistics.constructFromObject(
          data['statistics']
        );
      }
      if (data.hasOwnProperty('services')) {
        obj['services'] = ApiClient.convertToType(data['services'], [
          LabService,
        ]);
      }
      if (data.hasOwnProperty('experiments')) {
        obj['experiments'] = ApiClient.convertToType(data['experiments'], [
          LabExperiment,
        ]);
      }
      if (data.hasOwnProperty('datasets')) {
        obj['datasets'] = LabFileCollection.constructFromObject(
          data['datasets']
        );
      }
