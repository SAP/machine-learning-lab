...
function ColumnButton(props) {
    ...
    const buttonValue = GridFormatter.makeUpperCaseAndAddWhitespace(props.attribute);
    ...
    return (
        <Button
            ...
            onClick={onClick}
        >
            <span className={props.classes.buttonValue}>
                {buttonValue}
            </span>
        </Button>
    );
...
function Column(props) {
    const capitalizedColumnName = props.columnName.charAt(0).toUpperCase() + props.columnName.slice(1);

    return (
        <div className={props.classes.column}>
            <Typography className={props.classes.headerCell}>{capitalizedColumnName}</Typography>
            ...
            >
                ...
                <DialogActions>
                    <Button size="small" color="primary" onClick={onCancel}>
                        <Typography className={props.classes.actionButton}>Cancel</Typography>
                    </Button>
                    <Button size="small" color="primary">
                        <Typography className={props.classes.actionButton} onClick={onOk}>OK</Typography>
                    </Button>
                </DialogActions>
            </Dialog>
        </div>
